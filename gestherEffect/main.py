...
class HandControl(object):
    ...
    def _calcAngle(self, right_x, right_y, middle_x, middle_y, top_x, top_y):
        radians = np.arctan2(top_y - middle_y, top_x - middle_x) \
                  - np.arctan2(right_y - middle_y, right_x - middle_x)
    ...
    def gesture(self):
        ...
        while True:
            ...
            if len(lmList) != 0:
                ...
                thumb_middle_length_pip = self._getLength(right_thumb_tip_x, right_thumb_tip_y,
                                                          right_middle_finger_pip_x, right_middle_finger_pip_y
                                                          )

                thumb_middle_length_dip = self._getLength(right_thumb_tip_x, right_thumb_tip_y,
                ...
                cv2.putText(img, "Raise hand!!", (right_index_finger_tip_x, right_index_finger_tip_y), cv2.FONT_HERSHEY_COMPLEX, 1, (0, 255, 0), 3)
                ...
                #
                # if threeGesture:
                #     cv2.putText(img, "3", (right_index_finger_tip_x, right_index_finger_tip_y),
                #                 cv2.FONT_HERSHEY_SIMPLEX, 4, (0, 0, 255), 4, cv2.LINE_AA)
